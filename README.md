...
I build quantitative finance tools at the intersection of financial analysis and data science. Background in Computer Science (UCD Dublin), now focused on portfolio strategy, risk management, and systematic investing.
...
Rules-based equity strategy selecting the top 30 S&P 500 stocks monthly using value, momentum, and quality factor scores. 2018–2024 backtest across 501 securities.
- **47% reduction in max drawdown** vs S&P 500 equal-weight benchmark (-12.6% vs -23.9%)
...
### [Valuation — Applied Materials (AMAT)](https://github.com/kabirguglani/amat-valuation)
...
**Finance:** Valuation · Financial Modelling · Portfolio Management · Risk Management · FactSet · Capital IQ

---

## 📈 Currently Working On
- Risk Management project — VaR, stress testing, scenario analysis
- CFA Level 2 (exam prep)
